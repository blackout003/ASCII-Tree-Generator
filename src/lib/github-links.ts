...
/** Issue forms live in .github/ISSUE_TEMPLATE (bug_report.md, feature_request.md, emoji_suggestion.md). */
export const GITHUB_ISSUE_URLS = {
  ...
  emoji: `${GITHUB_REPO_URL}/issues/new?template=emoji_suggestion.md`,
} as const;
